    ...
    useCallback(() => {
      const unsubscribe = onAuthStateChanged(auth, (user) => {
        if (user) {
          ...
          if (email === "zeyadmostafa201@gmail.com") {
            setIsAdmin(true);
          } else {
            setIsAdmin(false);
          }
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={{ marginHorizontal: 20 }}>
        {isAdmin && (
          <Pressable
            onPress={() => router.push("/AdminDashboardScreen")}
            style={({ pressed }) => [
              {
                backgroundColor: pressed ? "#d81b60" : "#f06292",
                transform: [{ scale: pressed ? 0.97 : 1 }],
              },
              styles.actionBtn,
            ]}
          >
            <Text style={styles.actionText}>Admin Page</Text>
          </Pressable>
        )}
        ...
        <Pressable
          ...
          style={({ pressed }) => [
            {
              backgroundColor: pressed ? "#e91e63" : "#fb6090",
              transform: [{ scale: pressed ? 0.97 : 1 }],
            },
            styles.actionBtn,
          ]}
      ...
      <View style={styles.avatarGlowWrapper}></View>
    </ScrollView>
  );
}
